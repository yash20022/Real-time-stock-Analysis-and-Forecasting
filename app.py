...
with st.sidebar:
    st.markdown("# Extract Stock Sentiment,Stock Analysis & Forecasting")
    ...
    date_to = st.date_input("To",datetime.date(2024, 1, 11))
...
if btn:
    ...
    st.markdown("### Moving Average Convergence Divergence Indicator")
    ...
    st.markdown("### Relative Strenght Index Indicator")
    ...
    st.markdown("### Simple Moving Average Indicator")
    ...
    st.markdown("### Exponential Moving Average Indicator")
...
st.write("Yash Satish Badgujar")
st.write("Anant Rajendra Baviskar")
st.write("kunal Mali")
st.write("Piyush Rajendra Patil")
